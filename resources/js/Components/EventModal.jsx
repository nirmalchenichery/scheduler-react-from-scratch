...
const labelsClasses = ["yellow", "gray", "green", "blue", "red", "orange"];
...
export default function EventModal() {
    ...
    function handleSubmit(e)  {
        ...
        const calenderEvent = {
            ...
            description,
            label: selectedLabel,
            day: daySelected.valueOf(), //number
    ...
    return (
        <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center">
            <form action="" className="bg-white rounded-lg shadow-2xl w-1/4">
                ...
                <div className="p-3">
                    <div className="grid grid-cols-1/5 items-end gap-y-1">
                        <div></div>
                        <input
                            type="text"
                            name="title"
